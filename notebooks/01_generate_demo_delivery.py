...
orders = [
    ("O-3001", 1, "C-1001", "P-2001", delivery_date, delivery_date, delivery_date, "SHIPPED", 1, 1200.00, 0.00, 1200.00, "EUR"),
    ("O-3002", 1, "C-1002", "P-2002", delivery_date, None, None, "OPEN", 2, 35.00, 5.00, 65.00, "EUR"),
]
...
order_schema = T.StructType([
    ...
    T.StructField("customer_key", T.StringType(), False), T.StructField("product_key", T.StringType(), False),
